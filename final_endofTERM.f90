...
OPEN(12, FILE='C:\Users\user\Desktop\A.txt')
OPEN(13, FILE='C:\Users\user\Desktop\B.txt')
OPEN(14, FILE='C:\Users\user\Desktop\C.txt')
OPEN(15, FILE='C:\Users\user\Desktop\D.txt')
OPEN(16, FILE='C:\Users\user\Desktop\E.txt')
...
IF(STN(M)==108) WRITE(12,*) (TA(I,1),I=1,24),(CA_TOT(I,1),I=1,24)
IF(STN(I)==159)	WRITE(13,*) (TA(I,1),I=1,24),(CA_TOT(I,1),I=1,24)
IF(STN(M)==143)	WRITE(14,*) (TA(I,1),I=1,24),(CA_TOT(I,1),I=1,24)
IF(STN(M)==156)	WRITE(15,*) (TA(I,1),I=1,24),(CA_TOT(I,1),I=1,24)
IF(STN(M)==133)	WRITE(16,*) (TA(I,1),I=1,24),(CA_TOT(I,1),I=1,24)
